      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
        ...
        <div className="h-24 flex justify-center md:justify-start">
          <img
            ...
            alt="VideoBox"
            className="h-full object-contain grayscale opacity-50 hover:opacity-100 transition-opacity"
          />
        </div>

        <div className="flex justify-center gap-8 text-sm font-medium text-gray-400">
          <a href="/#product" className="hover:text-[#018CCB]">
            Product
          </a>
          <a href="/#privacy" className="hover:text-[#018CCB]">
            Privacy
          </a>
          <a href="/#terms" className="hover:text-[#018CCB]">
            Terms
          </a>
        </div>
